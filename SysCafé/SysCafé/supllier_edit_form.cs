...
namespace SysCafé
{
    public partial class supllier_edit_form : Form
    {
        ...
        {
            model.edit_sup_info(sup_name_txt.Text, sup_phone_txt.Text, sup_phonne2.Text, sup_address_txt.Text, sup_adress2.Text);
        ...
        {
            InitializeComponent();
            model.get_supplier_info(ref name,ref phone, ref phone2,ref adrees,ref adrees2);
